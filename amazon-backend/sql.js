            ...
            <div class="row">
                <div class="col">
                    <div class="card mt-50 mb-50 alert alert-success">
                        ...
                        <div class="col d-flex justify-content-center mb-50"><span class="h2" id="orderno"><b>order
                                Number : ${orderDetails[0].order_number} </b></span></div>
                        
                        <div class="col d-flex justify-content-center mb-50">
                             <a href="http://localhost:4200/userOrders">click here to check the orders</a>
                        </div>
